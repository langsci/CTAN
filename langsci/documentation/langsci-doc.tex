...
\option{{\textbackslash}includespinelogo}{The logo to be put on the spine}{{\textbackslash}includegraphics\{{\textbackslash}logopath langsci\_spinelogo\_nocolor\}}
\option{{\textbackslash}includestoragelogo}{The logo of the archiving institution}{{\textbackslash}includegraphics[width=5cm]\{{\textbackslash}logopath storagelogo.pdf\}}
\option{{\textbackslash}includepublisherlogo}{The publisher's logo in the impressum}{{\textbackslash}includegraphics\{{\textbackslash}logopath langsci\_logo\_nocolor.pdf\}}
\option{{\textbackslash}includechapterfooterlogo}{The logo to be used in chapter footers}{{\textbackslash}includegraphics\{{\textbackslash}logopath langsci\_spinelogo\_nocolor.pdf\}}
...
\option{{\textbackslash}lsAdvertisement}{Specify the advertisement on the last page of the book}{{\textbackslash}include\{{\textbackslash}logopath didyoulikethisbook\}}
